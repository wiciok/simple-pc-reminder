...
public class MainStageController implements Initializable
{
    ...
    */
    ...
    String buttonRemoveText = new String("Remove");
    String pageLabelText = new String("Page: ");
    
    /*STRINGI OD LABELI OGOLNYCH*/
    String descriptionLabelText = new String("Description:");
    String categoryLabelText = new String("Category:");
    String titleLabelText = new String("Title:");
    String startDateTimeText = new String("Start date and time:");
    String endDateTimeText = new String("End date and time:");
    String alertFrequencyText = new String("Alert frequency:");
    String priorityText = new String("Priority:");
    String isActiveText = new String("Is active?");
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        buttonRemove.setText(buttonRemoveText);
        pageLabel.setText(pageLabelText+Integer.toString(Scheduler.currentPage));
        ...
        /*LABELE OGOLNE*/
        descriptionLabel1.setText(descriptionLabelText);
        categoryLabel1.setText(categoryLabelText);
        titleLabel1.setText(titleLabelText);
        startDateTime1.setText(startDateTimeText);
        endDateTime1.setText(endDateTimeText);
        alertFrequency1.setText(alertFrequencyText);
        priority1.setText(priorityText);
        isActive1.setText(isActiveText);
        
        descriptionLabel2.setText(descriptionLabelText);
        categoryLabel2.setText(categoryLabelText);
        titleLabel2.setText(titleLabelText);
        startDateTime2.setText(startDateTimeText);
        endDateTime2.setText(endDateTimeText);
        alertFrequency2.setText(alertFrequencyText);
        priority2.setText(priorityText);
        isActive2.setText(isActiveText);
        
        descriptionLabel3.setText(descriptionLabelText);
        categoryLabel3.setText(categoryLabelText);
        titleLabel3.setText(titleLabelText);
        startDateTime3.setText(startDateTimeText);
        endDateTime3.setText(endDateTimeText);
        alertFrequency3.setText(alertFrequencyText);
        priority3.setText(priorityText);
        isActive3.setText(isActiveText);
